...
# window unpartition x.shape  torch.Size([16, 40, 40, 768])
# window partition x.shape  torch.Size([144, 14, 14, 768])
# Attention class x.shape  torch.Size([144, 14, 14, 768])
# attention x.shape  torch.Size([144, 14, 14, 768])
# window unpartition x.shape  torch.Size([16, 40, 40, 768])
# window partition x.shape  torch.Size([144, 14, 14, 768])
# Attention class x.shape  torch.Size([144, 14, 14, 768])
# attention x.shape  torch.Size([144, 14, 14, 768])
# window unpartition x.shape  torch.Size([16, 40, 40, 768])
# window partition x.shape  torch.Size([16, 40, 40, 768])
# Attention class x.shape  torch.Size([16, 40, 40, 768])
# attention x.shape  torch.Size([16, 40, 40, 768])
# window unpartition x.shape  torch.Size([16, 40, 40, 768])
# window partition x.shape  torch.Size([144, 14, 14, 768])
# Attention class x.shape  torch.Size([144, 14, 14, 768])
# attention x.shape  torch.Size([144, 14, 14, 768])
...
# window unpartition x.shape  torch.Size([16, 40, 40, 768])
    ...
    def forward(self, x):
        ...
        x = self.proj(x)
        # print ("Attention class x.shape ", x.shape)
...
class Block(nn.Module):
    ...
    def forward(self, x):
        ...
        # print ("window partition x.shape ", x.shape)
        ...
        # print ("window unpartition x.shape ", x.shape)
