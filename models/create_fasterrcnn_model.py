...
def return_fasterrcnn_dino(
    num_classes, pretrained=True, coco_model=False
):
    model = fasterrcnn_dino.create_model(
        num_classes, pretrained, coco_model=coco_model
    )
    return model

def return_fasterrcnn_dino_parul(
    num_classes, pretrained=True, coco_model=False
):
    model = fasterrcnn_dino_parul.create_model(
        num_classes, pretrained, coco_model=coco_model
    )
    return model
...
create_model = {
    ...
    'fasterrcnn_dino': return_fasterrcnn_dino,
    'fasterrcnn_dino_parul': return_fasterrcnn_dino_parul,
