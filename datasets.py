...
class CustomDataset(Dataset):
    ...
    def load_image_and_labels(self, index):
        ...
        # image_resized = (image_resized - [0.485, 0.456, 0.406]) / [0.229, 0.224, 0.225]
    ...
    def __getitem__(self, idx):
        ...
        # imagenet image normalization
        # print (image_resized.shape) # (3, 672, 672)
        # imagenet image normalization for image size (3, 672, 672)
        # imagenet_mean = torch.tensor([0.485, 0.456, 0.406])
        # imagenet_std = torch.tensor([0.229, 0.224, 0.225])
        # image_resized = (image_resized - imagenet_mean[:, None, None]) / imagenet_std[:, None, None]
